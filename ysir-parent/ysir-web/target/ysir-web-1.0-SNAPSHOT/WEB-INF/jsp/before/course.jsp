...
<nav class="w100">
    <div class="container">
        ...
        <ul class="text_13 f_right">
            <li>
                <a href="${pageContext.request.contextPath}/subject/queryAll">首页</a>
            </li>
            <li class="nav_down">
                ...
                <div class="section">
                    ...
                    <ul>
                        ...
                        <c:forEach items="${course.videoList}" var="video" varStatus="i">
                            <li class="section-main" onclick="getVideo(${video.id},${video.course_id})">
...
<script type="text/javascript">
    ...
    function getVideo(videoId,courseId) {
        ...
        if ((null != "${sessionScope.userAccount}" && "${sessionScope.userAccount}" != "") || ($("#isLogin").val() == 1)) {
            //如果登录
            location.href = "${pageContext.request.contextPath}/video/showVideo?id=" + videoId + "&cid=" + courseId +"&subject_name=" + '${subject.subject_name}';
        } else {
            //如果不登录，弹登录框
